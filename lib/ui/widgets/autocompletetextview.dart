...
class AutoCompleteTextView extends StatefulWidget
  ...
  AutoCompleteTextView(
      ...
      this.onTapCallback,
      this.maxHeight = 200,
      this.tfCursorColor = Colors.black12,
...
class _AutoCompleteTextViewState extends State<AutoCompleteTextView> {
  ...
  final suggestionsStreamController = new BehaviorSubject<List<Place>>();
  List<Place> suggestionShowList = List<Place>();
  Timer _debounce;
  ...
  _getSuggestions(String data) async {
    if (data.length > 0 && data != null) {
      List<Place> list = await widget.getSuggestionsMethod(data);
                          ...
                          return ConstrainedBox(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return ListTile(
                                    title: Text(
                                      suggestionShowList[index].placeName,
                                    ...
                                    onTap: () {
                                      ...
                                      widget.onTappedSuggestion(
                                          suggestionShowList[index].placeId);
                                    },
                                  );
                                }),
                          );
